...
ACCOUNT_INVALID = "error.account.invalid"
ADMIN_REQUIRED = "error.admin.required"
...
MESSAGE_SENDING = "error.message.sending"
SCHEDULE_TIME_FORMAT = "error.schedule.timeFormat"
SCHEDULE_INVALID_TIME = "error.schedule.invalidTime"
SCHEDULE_WINDOW_ORDER = "error.schedule.windowOrder"
SCHEDULE_WINDOW_MIN = "error.schedule.windowMinWidth"
SCHEDULE_WINDOW_PAST = "error.schedule.windowPastToday"
SCHEDULE_WINDOW_SLOT = "error.schedule.windowNoSlot"
